                    ...
                    <div className="overflow-hidden border-t-[2px] border-indigo-900 px-4 lg:px-8 py-4 lg:py-8">
                        <code className="font-mono text-xs md:text-sm lg:text-base">
                            <div className="blink">
                                ...
                                <span className="mr-2 text-white">unityCoder</span>
                            ...
                            <div>
                                ...
                                <span className="text-gray-400">{`'`}</span>
                                <span className="text-amber-300">Muhammad Awais</span>
                                <span className="text-gray-400">{`',`}</span>
                            </div>
                            <div className="ml-4 lg:ml-8 mr-2">
                                ...
                                <span className="text-gray-400">{"', '"}</span>
                                <span className="text-amber-300">Photon Quantum</span>
                                <span className="text-gray-400">{"', '"}</span>
                                <span className="text-amber-300">NavMesh AI</span>
                                <span className="text-gray-400">{"', '"}</span>
                                <span className="text-amber-300">Shader Graph</span>
                                <span className="text-gray-400">{"'],"}</span>
                            </div>
                            <div>
